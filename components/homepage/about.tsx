        ...
        <div className="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
          ...
          <div className="mt-8 lg:mt-0">
            ...
            <div className="prose prose-indigo mx-auto mt-5 text-gray-500 lg:col-start-1 lg:row-start-1 lg:max-w-none">
              <p>
              We are a family of born again believers who love Jesus, and seek to serve Him by obeying His Holy inspired word found in the Bible. We believe that true and abundant life begins by believing in the finished work of Jesus Christ on the cross of Calvary.
              </p>
            </div>
